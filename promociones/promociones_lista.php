...
<html>
  <head>
    ...
    function eliminar(id, elemento) {   // función para el botón de ocultar/eliminar 
      ...
      if(window.confirm("¿Eliminar este promociones?")){
        $.ajax({
          url        : "promociones_elimina.php", // URL del script PHP que realiza la eliminación
          type       : 'POST',
  ...
  <body>
    ...
    <br><a href="promociones_alta.php" id="newRegistro">Registrar nueva Promocion</a>
      <h3>Listado de promociones (<?php echo $num; ?>)</h3>
    <div id="tabla">
      <div class="nameColumna">ID</div>
      <div class="nameColumna">Nombre</div>
      <div class="nameColumna">Ver promociones</div>
    ...
    <!-- Lista que imprime PHP -->
      ...
      while($row = $res->fetch_array()){
        ...
        echo "<div class='fila'>
          ...
          <div class='columna'>
            <a href='promociones_detalle.php?id=$id'>Detalle</a></div> 
          <div class='columna'>
            <a href='promociones_editar.php?id=$id'>Editar</a></div>
          <div class='columna'>
