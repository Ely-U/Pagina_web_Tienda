...
<html>
  <head>
    ...
    function eliminar(id, elemento) {   // función para el botón de ocultar/eliminar 
      ...
      if(window.confirm("¿Eliminar este empleado?")){
        $.ajax({
          url        : "empleados_elimina.php", // URL del script PHP que realiza la eliminación
          type       : 'POST',
    ...
    #tabla {
      ...
      grid-template-columns: 50px 200px 200px 150px 100px 100px 100px;
  ...
  <body>
    ...
    <br><a href="empleados_alta.php" id="newRegistro">Crear nuevo registro</a>
      <h3>Listado de empleados (<?php echo $num; ?>)</h3>
    <div id="tabla">
      <div class="nameColumna">ID</div>
      <div class="nameColumna">Nombre completo</div>
      <div class="nameColumna">Correo</div>
      <div class="nameColumna">Rol</div>
      <div class="nameColumna">Ficha de empleado</div>
    ...
    <!-- Lista que imprime PHP -->
      ...
      while($row = $res->fetch_array()){
        ...
        echo "<div class='fila'>
          ...
          <div class='columna'>
            <a href='empleados_detalle.php?id=$id'>Detalle</a></div> 
          <div class='columna'>
            <a href='empleados_editar.php?id=$id'>Editar</a></div>
          <div class='columna'>
