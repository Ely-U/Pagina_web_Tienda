<?php
session_start();
if (isset($_SESSION['idUser'])) {        //Verifica si hay una sesión activa
    header('Location: bienvenido.php');  //Redirige a la página de bienvenida si ya está logueado
    exit();
        ...
        <script>
            ...
            function buscar() {
                ...
                if (correo && pass) {    //Si la variable correo y pass....
                    $.ajax({
                    url          : 'funciones/validaEmpleado.php',  // Ruta del archivo PHP que verifica si el empleado existe
                    ...
                    success      : function(res) {
                        if (res === '1') { 
                            window.location.href = "bienvenido.php"; // Redirige a bienvenido.php si existe
                        }else{
