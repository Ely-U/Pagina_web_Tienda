...
<html>
    <head>
        ...
        <script>
            function alertaValidar(){
                ...
                var apellidos = document.formulario01.apellidos.value
                var correo = document.formulario01.correo.value;
                var pass = document.formulario01.pass.value;
                var rol = document.formulario01.rol.value;
                ...
                if (nombre === ""||apellidos === ""||correo === ""|| pass === "" || rol === "0" || archivo ===""){
                    ...
                    document.formulario01.action = 'empleados_salva.php';
            ...
            function sale() {
                ...
                if (correo) {    //Si la variable correo....
                    ...
                    data         : {correo: correo},   //Enviando una variable correo con su respecivo valor
    ...
    <?php include('menu.php');?>
        ...
        <form name="formulario01" method="post" enctype="multipart/form-data" action="empleados_salva.php">
            ...
            <h4><a href="empleados_lista.php" id="regresar">Regresar al listado</a></h4>
        </form>
        </div>
    </body>
</html>