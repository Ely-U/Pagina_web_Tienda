<?php
//index.php           ESTA ES LA PAGINA DE HOME
session_start(); //Arrancas la sesión
require "funciones/conecta.php";
$con = conecta();

//Consultas diferentes para las promociones y los productos
$sqlPromo = "SELECT * FROM promociones WHERE eliminado = 0 ORDER BY RAND() LIMIT 1";
$resPromo = $con->query($sqlPromo);

//Prodcutos tomar 6 al azar 
$sqlProducto = "SELECT * FROM productos WHERE eliminado = 0 ORDER BY RAND() LIMIT 6";
...
<html>
  <head>
    ...
    if (cantidad > 0 && cantidad != '') {
      console.log("ID del producto:", id_producto); // Verifica si se está pasando el ID en la consola
      ...
      $.ajax({
        ...
        },error: function() { //Error de la solicitud
  ...
  <div class="container">
    <?php
    $promo    = $resPromo->fetch_assoc();  //Obtiene el resultado de la promoción
    $archivo  = $promo["archivo"];

    echo "<div class='banner'>
      <div class='imagen'>
      <img src='/proyecto/promociones/fotos/$archivo'>
      </div>
    </div>";
    ?>
