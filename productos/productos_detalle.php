...
<html>
    <head>
        <title>Ver Detalle del producto</title>
        <style>
            body {                              
    ...
    <body>
       ...
       <?php
        ...
        echo "<div class='fila'>
          ...
          <div class='texto'>Nombre del producto: $nombre</div>
          <div class='texto'>Codigo: $codigo</div>
          <div class='texto'>Descripción: $descripcion</div>
          <div class='texto'>Costo: $$costo pesos </div>
          <div class='texto'>Stock: $stock unidades</div>
        </div>";
        ?>
        
       <br><h3><a href="productos_lista.php" id="regresar">Regresar al listado</a></h3>
       </div>
    </body>
</html>
